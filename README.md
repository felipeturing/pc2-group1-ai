...
Finalmente se ha evaluado ciertos modelos para determinar el que mejor se acomode a nuestros datos y métricas esperadas (RMSE y R2SCORE), tales como: Regresión Lineal, Regresión Polinómica, RandomForestRegressor, GradientBoostingRegressor y Red Neuronal de Capas Densas.
